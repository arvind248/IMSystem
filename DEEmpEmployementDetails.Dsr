VERSION 5.00
Begin {C0E45035-5775-11D0-B388-00A0C9055D8E} DEEmpEmployementDetails 
   ClientHeight    =   6180
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   3165
   ...
   _ExtentY        =   10901
   FolderFlags     =   1
   TypeLibGuid     =   "{28A79C3C-20A1-41E6-80F1-D9FE2B928C8C}"
   TypeInfoGuid    =   "{0985A4B9-5A08-42A2-AF0C-BE70A2C9B4E4}"
   TypeInfoCookie  =   0
   Version         =   4
   NumConnections  =   1
   BeginProperty Connection1 
      ...
      ConnDispId      =   1001
      SourceOfData    =   3
      ConnectionSource=   "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:/project/db/IMS.accdb;Persist Security Info=False"
      Expanded        =   -1  'True
      QuoteChar       =   96
      SeparatorChar   =   46
   EndProperty
   ...
   BeginProperty Recordset1 
      ...
      BeginProperty Field19 
         ...
         Scale           =   0
         Type            =   202
         Name            =   "internshipcpmpanyname"
         Caption         =   "internshipcpmpanyname"
      EndProperty
   ...
   EndProperty
End
Attribute VB_Name = "DEEmpEmployementDetails"
